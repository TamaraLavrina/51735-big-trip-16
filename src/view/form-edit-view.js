import { TYPE, OFFERS_TYPES } from '../constants';
// const createPhotoTemplate = (photos) => photos.map((photo) => `<img class="event__photo" src="${photo}" alt="Event photo">`).join('');
const createOffersTemplate = (offers, type) => {
  OFFERS_TYPES.map((offer) => `<div class="event__offer-selector">
